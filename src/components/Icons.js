...
export const GithubIcon = () => {
  return (
    <div className="flex-none h-auto w-auto relative">
      <Link className="flex items-center cursor-pointer flex-row flex-nowrap gap-[10px] h-auto justify-center overflow-hidden p-[6px] relative no-underline w-auto will-change-transform">
        <div className="">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="pt-[10px]"
